...
class bus_booking:
    ...
    def home_page(self):
        ...
        bus = PhotoImage('C:/Users/singh/OneDrive/Desktop/python project/bus_for_project.png')
    ...
    def cover_page(self):
        ...
        bus = PhotoImage("bus_for_project.png")
        ...
        Label(root, text="\n\n\n\n\n Name:Abhinay Singh", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 221B014", font='Arial 16 bold', fg='blue').pack()
